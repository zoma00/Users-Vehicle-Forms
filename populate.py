    ...
    for i in range(num_vehicles):
        ...
        if model_name_distribution:
            random_manufacturer = random.choices(
                population=manufacturer_list,
                 weight, _ = model_name_distribution.values())
        else:
        ...
        client = Client.objects.create(
            ...
            last_name=last_name,
            email=email,
            phone_number=phone_number,  # Assign extracted core phone number
...
if __name__ == "__main__":
    ...
    # Example usage with custom parameters
      custom_params = {
        ...
        "model_name_distribution": {  # Indent this line
            "Toyota": 0.5,
            "Honda": 0.3,
            "BMW": 0.1,
            "Fiat": 0.1,
